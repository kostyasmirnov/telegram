...
const tgToken = "5513350107:AAFsotAt21LLQI7spMHrRRgxJWYJ8I3DnKk"
...
const helpMsg =
  ...
  \`фастфуд 200, самокат\`
  \`вчера такси 567\`
  \`5 дней назад зп 40000\`

_структура сообщения:_ \`когда(дата) что(категория) сколько комментарий(опционально)\`
`
